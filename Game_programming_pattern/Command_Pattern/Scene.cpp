...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	CreateCbvSrvDescriptorHeaps(pd3dDevice, 0, 2+2+1+1); //SuperCobra(17), Gunship(2), Player:Mi24(1), Skybox(1) -> 텍스쳐 수
	...
	CGunshipObject* pGunshipObject0 = new CGunshipObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature);
	pGunshipObject0->SetPosition(20.0f, 5.0f, 10.0f);
	pGunshipObject0->Rotate(0.0f, -90.0f, 0.0f);

	m_ppGameObjects[0] = pGunshipObject0;

	CGunshipObject *pGunshipObject1 = new CGunshipObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature);
	pGunshipObject1->SetPosition(-30.0f, -10.0f, 50.0f);
	pGunshipObject1->Rotate(0.0f, 90.0f, 0.0f);

	m_ppGameObjects[1] = pGunshipObject1;
